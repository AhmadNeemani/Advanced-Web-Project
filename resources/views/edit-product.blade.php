...
<div class="container my-5">
    ...
    <form action="{{ route('update-product', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="quantity" class="form-control w-75 mx-auto" value="{{ $product->quantity }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            @if($product->image)
                <img id="imagePreview" src="{{ asset('storage/' . $product->image) }}" alt="Product Image" width="100" class="mt-3">
            @else
        ...
        <button type="submit" class="btn" style="background-color: #FFC0CB; width: 200px; border: none; color: white;">Update Product</button>
    </form>
</div>
@endsection
